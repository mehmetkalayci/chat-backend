...
<div class="container mx-auto">
    <form action="{{ route('chatbot.store') }}" method="POST" class="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md">
        @csrf
        ...
        <div class="mb-4">
            ...
            <textarea name="description" id="description" class="form-input mt-1 block w-full h-20"></textarea>
        </div>

        <div class="mb-4">
            <label for="input_placeholder" class="block text-gray-700 font-semibold">Input Metni</label>
            <input type="text" name="input_placeholder" id="input_placeholder" class="form-input mt-1 block w-full" />
        </div>

        <div class="mb-4">
            <label for="first_message" class="block text-gray-700 font-semibold">İlk Mesaj</label>
            <input type="text" name="first_message" id="first_message" class="form-input mt-1 block w-full" />
        </div>

        <div class="mb-4">
            <label for="floating_button_name" class="block text-gray-700 font-semibold">Chatbot Buttonu Adı</label>
            <input type="text" name="floating_button_name" id="floating_button_name" class="form-input mt-1 block w-full" />
        </div>

        <div class="mb-4">
            <label for="close_button_name" class="block text-gray-700 font-semibold">Kapatma Buttonu Adı</label>
            <input type="text" name="close_button_name" id="close_button_name" class="form-input mt-1 block w-full" />
        </div>

        <div class="mb-4">
            <label for="chatbot_color" class="block text-gray-700 font-semibold">Chatbot Rengi</label>
            <input type="text" name="chatbot_color" id="chatbot_color" class="form-input mt-1 block w-full" />
        </div>
        ...
        <div class="mb-4">
            ...
            <div class="mt-2">
                <label class="inline-flex items-center">
                    <input type="radio" name="show_button_label" value="true" class="form-radio" />
                    <span class="ml-2">Evet</span>
                </label>
                <label class="inline-flex items-center ml-6">
                    <input type="radio" name="show_button_label" value="false" class="form-radio" />
        ...
        <div class="mb-4">
            ...
            <div class="mt-2">
                <label class="inline-flex items-center">
                    <input type="radio" name="alignment" value="right" class="form-radio" />
                    <span class="ml-2">Sağ</span>
                </label>
                <label class="inline-flex items-center ml-6">
                    <input type="radio" name="alignment" value="left" class="form-radio" />
        ...
        <div class="mb-4">
            ...
            <input type="number" name="horizontal_margin" id="horizontal_margin" class="form-input mt-1 block w-full" value="20" />
        </div>

        <div class="mb-4">
            <label for="vertical_margin" class="block text-gray-700 font-semibold">Dikey Kenar Boşluğu</label>
            <input type="number" name="vertical_margin" id="vertical_margin" class="form-input mt-1 block w-full" value="20" />
        </div>

        <div class="mb-4">
            <label for="login_url" class="block text-gray-700 font-semibold">Kullanıcı Giriş URL'i</label>
            <input type="text" name="login_url" id="login_url" class="form-input mt-1 block w-full" />
        </div>
